...
This config file sets up a remote config.
...
The remote config commands are sandboxed to only the ones you see in this example.

Next up is the import config.
Every key represents a local path and every value represents where you want to copy that folder to.
...
This way I have learned some Rust and the project is also faster than it would be as an NPM package.
